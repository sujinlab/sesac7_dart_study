...
import 'package:modu_3_dart_study/250704/repository/post_repository_impl.dart';
import 'package:test/expect.dart';
import 'package:test/scaffolding.dart';

Future<void> main() async {
  test('getPostByKeyword', () async {
    final json = [
      {
        "userId": 1,
        "id": 1,
    ...
    final posts = await PostRepositoryImpl(
      remoteDataSource,
    ).getPostByKeyword('facere');
